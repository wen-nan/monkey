...
type Node interface {
	...
	// String this method can print AST nodes for debugging and compare them
	// with other AST nodes.
	String() string
}
...
// ExpressionStatement fulfills the ast.Statement interface, so we can add it
// to the Statements slice of ast.Program.
...
type IntegerLiteral struct {
	Token token.Token
	Value int64 // contain the actual value
}
...
type PrefixExpression struct {
	...
	Operator string      // Contain either "-" or "!"
	Right    Expression  // contain expression to the right of the operator
}
...
// InfixExpression define ast.InfixExpression to fulfill the ast.Expression and
// ast.Node interfaces.
...
// Call expressions consist of an expression that results in a function when evaluated
// and a list of expressions that are the arguments to this function call.
...
// StringLiteral define ast.StringLiteral
...
// ArrayLiteral define ast.ArrayLiteral
